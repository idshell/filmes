...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Artista a1 = new Artista(null, "Loenardo Di Caprio", "EUA", new BigDecimal(10000000.00), sdf.parse("11/11/1974"));
			...
			Participacao p2 = new Participacao(null, "Haward Hughes", new BigDecimal("1000000.00"), f1, a1);
			...
			response.getWriter().append("Erro ao intanciar data. Instância não criada!");
		}
	}
}
